...
import com.sale.Campaign.Model.dto.ProductSale;
import com.sale.Campaign.Repository.CampaignRepo;
import com.sale.Campaign.Repository.PriceHistoryRepo;
...
public class CampaignService {
    ...
    public SaleCampaign addCampaign(CampaignDto campaignDto) throws ParseException {
...
//    @Scheduled(cron = "0 0 23 * * ?")
    public void updateProductPrices() {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); //
        String formattedDate = sdf.format(currentDate);
        List<SaleCampaign> activeCampaigns = campaignRepo.findActiveCampaigns("2023-10-19");
